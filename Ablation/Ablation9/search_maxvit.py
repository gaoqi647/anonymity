...
param_grid = np.array([[Architecture, Skip_Connections,
                        Activation_Functions, Pooling_Operations
                           , Regularization, Data_Augmentagion, Learning_Rate_Schedules,
                        Training_Algorithm, train_size, cos,Framwork,
                        batch_size, learning_rate, epochs]
                       for Architecture in param['Architecture']
                       ...
                       for Training_Algorithm in param['Training_Algorithm']
                       for train_size in param['train_size']
                       for cos in param['cos']
                       for Framwork in param['Framwork'] for batch_size in
                       param['batch_size']
                       for learning_rate in param['learning_rate'] for epochs in param['epochs']
                       ])
...
data.drop(['Input_Size', 'Hardware', 'Output Functions', 'Feedforward Networks', 'Convolutions', 'Normalization', 'paraeters', 'Number', 'number_label'],
          axis=1, inplace=True)
features = data.values
