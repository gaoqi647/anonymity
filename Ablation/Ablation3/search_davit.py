...
# davit
param = {'Architecture': [0.626941306048316],
         'Normalization': [0.08]
    , "Convolutions": [0]
    ...
    , "Pooling_Operations": [0.0,
                             ...
                             0.9523809523809523,
                             1.0]
    , "Regularization": [0.796138996138996]
    , "Data_Augmentagion": [0.0218281036834924]
    , "Feedforward_Networks": [0.428571428571428]
...
def search_best(param):
    xp, yp = bayesian_optimisation(n_iters=500,
                                   ...
                                   a=param['a'],
                                   b=param['b'])
    pd.DataFrame(xp, yp).to_csv('result/davit/' + str(round(param['a'], 2)) + '_' + str(round(param['b'], 2)) + '.csv')
    tmp1 = max(yp)
    tmp1 = tmp1 * 10000
    tmp2 = 500 - len(yp)
    return -tmp1 - tmp2
